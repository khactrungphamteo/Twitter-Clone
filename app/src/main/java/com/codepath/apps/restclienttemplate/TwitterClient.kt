...
class TwitterClient(context: Context) : OAuthBaseClient(
    ...
    companion object {
        val REST_API_INSTANCE: TwitterApi = TwitterApi.instance()  // create a Twitter API
    ...
    // this is where we can define method to connect to different API endpoints
    // utilize Twitter Client to populate the home timeline
